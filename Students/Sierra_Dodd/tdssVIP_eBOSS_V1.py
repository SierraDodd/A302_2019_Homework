...
class callback_handler:
	...
	if(PS1_matched_dist > 10):
	    ax3.set_title('error: closest matched distance = '+str(round(PS1_matched_dist,2))+'"', color = 'r')
        else: 
        ...
        # Modified 3/22/19 to add warning title if PS1 match is more than 10 arcseconds away
        if(PS1_matched_dist > 10):
            ax4.set_title('photometry warning: matched distance error', color = 'r')
...
if len(sys.argv) == 3:
    ...
    ##global ax3
    # Modified 3/22/19 to add warning title in red if PS1 match is more than 10 arcseconds away
    ax3 = subplot2grid((2,3), (1,0),colspan=1)
    if(PS1_matched_dist > 10):
        ax3.set_title('error: closest matched distance = '+str(round(PS1_matched_dist,2))+'"', color = 'r')
    else: 
